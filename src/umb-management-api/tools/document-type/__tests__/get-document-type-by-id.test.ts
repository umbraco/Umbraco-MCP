          ...
          text: JSON.stringify({
            ...
            containers: (parsed.containers || []).map((container: any) => ({
              ...
              parent: container.parent
                ? { ...container.parent, id: BLANK_UUID }
                : null,
            })),
            // Normalize IDs in allowedTemplates array
            allowedTemplates: (parsed.allowedTemplates || []).map(
              (template: any) => ({
                ...template,
                id: BLANK_UUID,
              })
            ...
            allowedDocumentTypes: (parsed.allowedDocumentTypes || []).map(
              (docType: any) => ({
                ...docType,
            ...
            compositions: (parsed.compositions || []).map(
              (composition: any) => ({
                ...composition,
