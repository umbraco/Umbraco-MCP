 ...
 * @deprecated
 */
export const getContentQuerySkipDefault = 0;export const getContentQueryTakeDefault = 10;
...
export const getContentQueryParams = zod.object({
  ...
  "take": zod.number().default(getContentQueryTakeDefault).describe('Specifies the number of found content items to take. Use this to control pagination of the response.'),
...
export const getContent20QueryParams = zod.object({
  ...
  "sort": zod.array(zod.string()).optional().describe('Defines how to sort the found content items. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this.'),
  "skip": zod.number().optional().describe('Specifies the number of found content items to skip. Use this to control pagination of the response.'),
  "take": zod.number().default(getContent20QueryTakeDefault).describe('Specifies the number of found content items to take. Use this to control pagination of the response.'),
  "expand": zod.string().optional().describe('Defines the properties that should be expanded in the response. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this.'),
