...
export const getContentQueryParams = zod.object({
    fetch: zod
        .string()
        .optional()
        .describe("Specifies the content items to fetch. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this."),
    filter: zod
        .array(zod.string())
        .optional()
        .describe("Defines how to filter the fetched content items. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this."),
    sort: zod
        .array(zod.string())
        .optional()
        .describe("Defines how to sort the found content items. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this."),
    skip: zod
        .number()
        .optional()
        .describe("Specifies the number of found content items to skip. Use this to control pagination of the response."),
    take: zod
        .number()
    ...
    expand: zod
        .string()
        .optional()
        .describe("Defines the properties that should be expanded in the response. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this."),
});
export const getContentHeader = zod.object({
    "Accept-Language": zod
        .string()
        .optional()
        .describe("Defines the language to return. Use this when querying language variant content items."),
    "Api-Key": zod
        .string()
        .optional()
...
export const getContentResponse = zod.object({
    ...
    items: zod.array(zod.object({
        ...
        cultures: zod.record(zod.string(), zod.object({
            path: zod.string(),
            startItem: zod.object({
                id: zod.string().uuid(),
                path: zod.string(),
...
export const getContent20QueryParams = zod.object({
    fetch: zod
        .string()
        .optional()
        .describe(`The selector allows you to fetch different subsets of items based on a GUID or path of a specific content item. The Delivery API will search all available content items if no fetch parameter is provided. The following built-in selectors can be used out of the box:
...
Only one selector option can be applied to a query at a time. You cannot combine multiple fetch parameters in a single query. An example Id would be dc1f43da-49c6-4d87-b104-a5864eca8152, an example path would be /blog/`),
    ...
    fields: zod
        .string()
        .optional()
        .describe("Explicitly defines which properties should be included in the response (by default all properties are included). Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api#query-parameters) for more details on this."),
});
...
export const getContentItems20Response = zod.array(getContentItems20ResponseItem);
/**
 * @deprecated
 */
...
export const getMediaQueryParams = zod.object({
    fetch: zod
        .string()
        .optional()
        .describe("Specifies the media items to fetch. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api/media-delivery-api#query-parameters) for more details on this."),
    filter: zod
        .array(zod.string())
        .optional()
        .describe("Defines how to filter the fetched media items. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api/media-delivery-api#query-parameters) for more details on this."),
    sort: zod
        .array(zod.string())
        .optional()
        .describe("Defines how to sort the found media items. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api/media-delivery-api#query-parameters) for more details on this."),
    skip: zod
        .number()
        .optional()
        .describe("Specifies the number of found media items to skip. Use this to control pagination of the response."),
    take: zod
        .number()
    ...
    expand: zod
        .string()
        .optional()
        .describe("Defines the properties that should be expanded in the response. Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api/media-delivery-api#query-parameters) for more details on this."),
});
...
export const getMedia20QueryParams = zod.object({
    ...
    fields: zod
        .string()
        .optional()
        .describe("Explicitly defines which properties should be included in the response (by default all properties are included). Refer to [the documentation](https://docs.umbraco.com/umbraco-cms/reference/content-delivery-api/media-delivery-api#query-parameters) for more details on this."),
});
