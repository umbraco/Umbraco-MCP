...
export const getDataTypeByIdReferencesResponse = zod.array(
  getDataTypeByIdReferencesResponseItem
);
...
export const getTreeDataTypeAncestorsResponse = zod.array(
  getTreeDataTypeAncestorsResponseItem
);
...
export const getItemDictionaryResponse = zod.array(
  getItemDictionaryResponseItem
);
...
export const getTreeDictionaryAncestorsResponse = zod.array(
  getTreeDictionaryAncestorsResponseItem
);
...
export const getItemDocumentBlueprintResponse = zod.array(
  getItemDocumentBlueprintResponseItem
);
...
export const getTreeDocumentBlueprintAncestorsResponse = zod.array(
  getTreeDocumentBlueprintAncestorsResponseItem
);
...
export const getTreeDocumentBlueprintChildrenQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getTreeDocumentBlueprintChildrenQueryTakeDefault),
  foldersOnly: zod.coerce.boolean().optional(),
});
...
export const getTreeDocumentBlueprintRootQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getTreeDocumentBlueprintRootQueryTakeDefault),
  foldersOnly: zod.coerce.boolean().optional(),
});
...
export const postDocumentTypeBody = zod.object({
  ...
  allowedDocumentTypes: zod.array(
    zod.object({
      documentType: zod.object({
        id: zod.string().uuid(),
      }),
...
export const getDocumentTypeByIdAllowedChildrenQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getDocumentTypeByIdAllowedChildrenQueryTakeDefault),
});
...
export const getDocumentTypeByIdBlueprintQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getDocumentTypeByIdBlueprintQueryTakeDefault),
});
...
export const getDocumentTypeByIdCompositionReferencesResponse = zod.array(
  getDocumentTypeByIdCompositionReferencesResponseItem
);
...
export const getDocumentTypeAllowedAtRootQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getDocumentTypeAllowedAtRootQueryTakeDefault),
});
...
export const postDocumentTypeAvailableCompositionsResponse = zod.array(
  postDocumentTypeAvailableCompositionsResponseItem
);
...
export const getItemDocumentTypeResponse = zod.array(
  getItemDocumentTypeResponseItem
);
...
export const getTreeDocumentTypeAncestorsResponse = zod.array(
  getTreeDocumentTypeAncestorsResponseItem
);
...
export const getTreeDocumentTypeChildrenQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getTreeDocumentTypeChildrenQueryTakeDefault),
  foldersOnly: zod.coerce.boolean().optional(),
});
    ...
    zod.object({
      ...
      variants: zod.array(
        zod.object({
          ...
          publishDate: zod.string().datetime({ local: true }).nullish(),
          scheduledPublishDate: zod
            .string()
            .datetime({ local: true })
            .nullish(),
          scheduledUnpublishDate: zod
            .string()
            .datetime({ local: true })
            .nullish(),
        })
...
export const getDocumentByIdNotificationsResponse = zod.array(
  getDocumentByIdNotificationsResponseItem
);
...
export const getDocumentByIdReferencedByQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getDocumentByIdReferencedByQueryTakeDefault),
});
...
export const getDocumentByIdReferencedDescendantsQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getDocumentByIdReferencedDescendantsQueryTakeDefault),
});
...
export const putUmbracoManagementApiV11DocumentByIdValidate11Params =
  zod.object({
    id: zod.string().uuid(),
  });
...
export const getRecycleBinDocumentChildrenQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getRecycleBinDocumentChildrenQueryTakeDefault),
});
...
export const getTreeDocumentAncestorsResponse = zod.array(
  getTreeDocumentAncestorsResponseItem
);
...
export const getDynamicRootStepsResponse = zod.array(
  getDynamicRootStepsResponseItem
);
...
export const getImagingResizeUrlsResponse = zod.array(
  getImagingResizeUrlsResponseItem
);
...
export const getIndexerResponse = zod.object({
  ...
  items: zod.array(
    zod.object({
      ...
      providerProperties: zod
        .record(zod.string(), zod.any().nullable())
        .nullish(),
    })
  ),
});
...
export const postInstallSetupBody = zod.object({
  user: zod.object({
    name: zod
      .string()
      .min(postInstallSetupBodyUserNameMin)
      .max(postInstallSetupBodyUserNameMax),
...
export const getLogViewerLogQueryParams = zod.object({
  ...
  logLevel: zod
    .array(
      zod.enum(["Verbose", "Debug", "Information", "Warning", "Error", "Fatal"])
    )
    .optional(),
  startDate: zod.string().datetime({ local: true }).optional(),
  endDate: zod.string().datetime({ local: true }).optional(),
...
export const getLogViewerMessageTemplateQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getLogViewerMessageTemplateQueryTakeDefault),
  startDate: zod.string().datetime({ local: true }).optional(),
  endDate: zod.string().datetime({ local: true }).optional(),
});
...
export const getManifestManifestResponse = zod.array(
  getManifestManifestResponseItem
);
...
export const getManifestManifestPrivateResponse = zod.array(
  getManifestManifestPrivateResponseItem
);
...
export const getManifestManifestPublicResponse = zod.array(
  getManifestManifestPublicResponseItem
);
...
export const getMediaTypeByIdAllowedChildrenQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getMediaTypeByIdAllowedChildrenQueryTakeDefault),
});
...
export const getMediaTypeByIdCompositionReferencesResponse = zod.array(
  getMediaTypeByIdCompositionReferencesResponseItem
);
...
export const postMediaTypeAvailableCompositionsResponse = zod.array(
  postMediaTypeAvailableCompositionsResponseItem
);
...
export const getTreeMediaTypeAncestorsResponse = zod.array(
  getTreeMediaTypeAncestorsResponseItem
);
...
export const getMediaByIdReferencedDescendantsQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getMediaByIdReferencedDescendantsQueryTakeDefault),
});
...
export const getTreeMediaAncestorsResponse = zod.array(
  getTreeMediaAncestorsResponseItem
);
...
export const getItemMemberGroupResponse = zod.array(
  getItemMemberGroupResponseItem
);
...
export const getItemMemberTypeResponse = zod.array(
  getItemMemberTypeResponseItem
);
...
export const getMemberTypeByIdCompositionReferencesResponse = zod.array(
  getMemberTypeByIdCompositionReferencesResponseItem
);
...
export const postMemberTypeAvailableCompositionsResponse = zod.array(
  postMemberTypeAvailableCompositionsResponseItem
);
...
export const getItemPartialViewResponse = zod.array(
  getItemPartialViewResponseItem
);
...
export const getTreePartialViewAncestorsResponse = zod.array(
  getTreePartialViewAncestorsResponseItem
);
...
export const getItemRelationTypeResponse = zod.array(
  getItemRelationTypeResponseItem
);
...
export const getRelationByRelationTypeIdQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getRelationByRelationTypeIdQueryTakeDefault),
});
...
export const getTreeScriptAncestorsResponse = zod.array(
  getTreeScriptAncestorsResponseItem
);
...
export const getSearcherBySearcherNameQueryQueryParams = zod.object({
  ...
  take: zod.coerce
    .number()
    .default(getSearcherBySearcherNameQueryQueryTakeDefault),
});
...
export const getItemStaticFileResponse = zod.array(
  getItemStaticFileResponseItem
);
...
export const getTreeStaticFileAncestorsResponse = zod.array(
  getTreeStaticFileAncestorsResponseItem
);
...
export const getItemStylesheetResponse = zod.array(
  getItemStylesheetResponseItem
);
...
export const getTreeStylesheetAncestorsResponse = zod.array(
  getTreeStylesheetAncestorsResponseItem
);
...
export const getTreeTemplateAncestorsResponse = zod.array(
  getTreeTemplateAncestorsResponseItem
);
...
export const deleteUserGroupByIdUsersBody = zod.array(
  deleteUserGroupByIdUsersBodyItem
);
...
export const postUserGroupByIdUsersBody = zod.array(
  postUserGroupByIdUsersBodyItem
);
...
export const getFilterUserResponse = zod.object({
  ...
  items: zod.array(
    zod.object({
      ...
      documentStartNodeIds: zod.array(
        zod.object({
          id: zod.string().uuid(),
        })
      ),
      hasDocumentRootAccess: zod.boolean(),
      mediaStartNodeIds: zod.array(
        zod.object({
          id: zod.string().uuid(),
        })
      ),
...
export const getUserByIdClientCredentialsResponse = zod.array(
  getUserByIdClientCredentialsResponseItem
);
...
export const getUserCurrent2faResponse = zod.array(
  getUserCurrent2faResponseItem
);
...
export const getUserCurrentLoginProvidersResponse = zod.array(
  getUserCurrentLoginProvidersResponseItem
);
...
export const getUserCurrentPermissionsDocumentResponse = zod.array(
  getUserCurrentPermissionsDocumentResponseItem
);
